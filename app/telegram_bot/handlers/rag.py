...
async def format_post_with_gemini(repo_name: str, commits: list) -> str:
    ...
    prompt = (
        ...
        f"Используй сленг из повседневной жизни и эмодзи (🔥🚀💻). Максимум 3500 символов. Не используй большие пробелы между абзацами. Одинарной строки пропуска будет достаточно "
